...
<Header 
        h1Text="Contact Me" 
        backgroundImage="https://github.com/StartBootstrap/startbootstrap-clean-blog/blob/master/src/assets/img/contact-bg.jpg?raw=true" 
        subheadingText="Do you have questions? I have Answers"
      />
                    ...
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div className="my-5">
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div className="form-floating">
                                    <textarea className="form-control" id="message" placeholder="Enter your message here..." style= {{height: 64} } data-sb-validations="required"></textarea>
