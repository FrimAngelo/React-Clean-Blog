...
<div>
<Header 
        h1Text="Man must explore, and this is exploration at its greatest" 
        backgroundImage="https://github.com/StartBootstrap/startbootstrap-clean-blog/blob/master/src/assets/img/post-bg.jpg?raw=true" 
        subheadingText="Problems look mighty small from 150 miles up"
            ...
            <div className="container px-4 px-lg-5">
                <div className="row gx-4 gx-lg-5 justify-content-center">
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        <p>Never in all their history have men been able truly to conceive of the world as one: a single sphere, a globe, having the qualities of a globe, a round earth in which all the directions eventually meet, in which there is no center because every point, or none, is center — an equal earth which all men occupy as equals. The airmas earth, if free men make it, will be truly round: a globe in practice, not in theory.</p>
